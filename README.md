...
```
cd existing_repo
git remote add origin https://gitlab.com/JasonMarechal25/dockerimages.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/JasonMarechal25/dockerimages/-/settings/integrations)
